...
import com.arifahmadalfian.borutoapp.ui.theme.EXTRA_SMALL_PADDING
import com.arifahmadalfian.borutoapp.ui.theme.LightGray
import com.arifahmadalfian.borutoapp.ui.theme.StarColor
import com.arifahmadalfian.borutoapp.util.Constants.EMPTY_STARS
import com.arifahmadalfian.borutoapp.util.Constants.FILLED_STARS
import com.arifahmadalfian.borutoapp.util.Constants.HALF_FILLED_STARS
...
fun calculateStars(rating: Double): Map<String, Int> {
    ...
    LaunchedEffect(key1 = rating) {
        ...
        if (firstNumber in 0..5 && lastNumber in 0..9) {
            ...
            Log.d("RattingWidget", "Invalid rating number")
        }
    }
